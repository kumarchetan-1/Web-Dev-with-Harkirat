...
function Counter() {
  ...
  useEffect(function () {
    ...
    const clock = setInterval(() => {
      ...
      // setCount(count+1) // if we use this syntax, please provide this variable in dependancy array
      setCount(count => count + 1) // prefer to use it bcz it works well if dependancy array is empty or have some state variable.
    }, 1000)
