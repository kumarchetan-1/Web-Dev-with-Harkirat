...
export default function Signin() {
    ...
    return <div className="w-screen h-screen flex items-center justify-center" >
        <div className="border border-white min-w-[500px] px-10 py-12 bg-slate-200  rounded-md">
             ...
             <div>
             <button className="inline-block w-full p-4 bg-violet-700 text-white font-bold rounded-md border transition-all hover:transition-all border-violet-700 hover:bg-white hover:border-violet-700 hover:text-violet-900" onClick={()=>{
